...
using System.Data;
static class BD{
private static string _connectionString = @"Server=.\SQLEXPRESS; Database=PreguntadOrt; Integrated Security=True; TrustServerCertificate=True; TrustServerCertificate=true;";
